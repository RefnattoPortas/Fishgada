          ...
          <div className="relative glass-elevated rounded-[32px] md:rounded-[40px] p-6 md:p-12 border border-white/5 overflow-hidden">
            ...
            <div className="relative flex flex-row items-start text-left gap-4 md:gap-12">
              ...
              <div className="flex flex-col items-center gap-2 shrink-0 max-w-[80px] md:max-w-none">
                ...
                {/* Rank (Patente) */}
                <div className="inline-flex items-center gap-1 px-2 md:px-4 py-2 md:py-1.5 min-h-[44px] bg-white/5 border border-white/10 rounded-full mt-1">
                ...
                {currentUser && currentUser.id !== profile.id && (
                  <button 
                    ...
                    className={`px-2 md:px-5 py-2.5 md:py-2 min-h-[44px] rounded-lg md:rounded-xl border font-black uppercase tracking-widest text-[7px] md:text-[10px] transition-all flex flex-col md:flex-row items-center justify-center gap-1 shadow-lg mt-1 w-full text-center leading-tight ${
                      isFollowing 
              ...
              <div className="flex-1 space-y-1.5 md:space-y-4 pt-1 md:pt-0 overflow-hidden">
                ...
                <p className="text-accent font-bold text-[9px] md:text-xs flex items-center justify-start gap-1 truncate">
                  <MapPin size={10} className="shrink-0 md:w-3 md:h-3" /> <span className="truncate">{(profile.city || '---').trim()}, {profile.state || '---'}</span>
                </p>
            ...
            <div className="flex gap-2 p-1.5 glass-elevated rounded-2xl border border-white/5 w-full md:w-fit overflow-x-auto no-scrollbar">
              {[
                ...
                <button
                  ...
                  className={`py-3 px-5 md:px-6 min-h-[44px] text-[10px] md:text-xs font-black uppercase tracking-widest transition-all rounded-xl flex items-center justify-center gap-2.5 flex-1 md:flex-none whitespace-nowrap ${
